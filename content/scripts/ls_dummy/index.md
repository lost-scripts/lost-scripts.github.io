---
Title: LS Dummy Script
Description: A dummy script/placeholder just for the sake of testing different parts of the READMEs and Lost Script™ webpage.
Tags: [other]
    ...
    <tr>
        <td align='center' valign='middle' width='96'>
            <picture>
                ...
                <img src='assets/icon.png' width='48' alt='Icon' title='Dummy: A dummy script/placeholder just for the sake of testing different parts of the READMEs and Lost Script&trade; webpage.' class='colorize'>
            </picture>
        </td>
        <td align='right' valign='middle' width='916' nowrap>
            <a href='https://github.com/lost-scripts/ls_dummy/releases/latest/download/ls_dummy.zip' title='Download latest version...'><img src='https://img.shields.io/github/downloads/lost-scripts/ls_dummy/total?logo=data:image/svg%2bxml;base64,&color=blue&label=Download' alt='Download'></a> 
            <a href='https://github.com/lost-scripts/ls_dummy/releases/latest' title='Go to release in GitHub...'><img src='https://img.shields.io/github/v/release/lost-scripts/ls_dummy?logo=github&color=yellow&label=Release' alt='Release'></a> 
...
![NORMAL Mode](assets/image_gallery_mode_1.png "NORMAL Mode for basic funtionality")
</td><td width="178" valign="top">

![ADVANCED Mode](assets/image_gallery_mode_2.png "ADVANCED Mode for fine control")
</td><td width="178" valign="top">
</td>
</tr></table>
</details>
